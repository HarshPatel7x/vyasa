...
- [squash-merge.md](squash-merge.md) — plan to switch the repo to squash-merge so every mainline commit is a structured, already-validated PR-title subject (no more `Merge pull request #N…`). Status: drafted, awaiting user sign-off.
